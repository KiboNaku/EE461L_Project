...
=======
import "./Hardware.css"
>>>>>>> 1f4c8ad7e1501a2ab83674898587129cd6a50214
            ...
            <div className="dark-background hardware-page">
                <div className="full-screen-height ">
                    <Card className="hardware-card light-background text-light">
                        <Card.Header>Hardware Sets</Card.Header>
                        <Card.Body >
                            <table id="fixed-table" class="table table-bordered hardware-table text-light">
                                <thead>
                                    <tr>
                                        <th style={{ width: 200 }}>Name</th>
                                        <th style={{ width: 200 }}>Sets Available</th>
                            ...
                            <div class="row justify-content-center">
                                <button id="modalButton" type="button" className="btn btn-primary button-primary btn-md"
                                    data-toggle="modal" data-target="#check-modal" onClick={this.displayCart}>
                                    Checkout
>>>>>>> 1f4c8ad7e1501a2ab83674898587129cd6a50214
                            </button>
